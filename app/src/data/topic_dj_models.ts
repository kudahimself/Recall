...
export const dj_models_questions: Question[] = [
  {
      ...
      tieredHints: {
        apiSignature: 'models.DateTimeField(auto_now_add=False, auto_now=False)',
        skeleton: 'from django.db import models\n\nclass Article(models.Model):\n    title = models.____(____=200)\n    body = models.____()\n    author = models.____(max_length=100)\n    published_date = models.____(____=True)\n    is_published = models.____(____=False)',
      },
    ...
    },
  {
      ...
      tieredHints: {
        apiSignature: 'models.ForeignKey(to, on_delete, related_name=None)',
        skeleton: 'from django.db import models\n\nclass Comment(models.Model):\n    article = models.____("Article", ____=models.____)\n    author = models.____(max_length=100)\n    body = models.____()\n    created_at = models.____(____=True)',
      },
...
class Book(models.Model):
    ...
    def __str__(self):
      ...
      tieredHints: {
        apiSignature: 'def __str__(self) -> str',
        skeleton: 'from django.db import models\n\nclass Book(models.Model):\n    title = models.____(____=200)\n    author = models.____(____=100)\n\n    def ____(self):\n        ____ f"{self.____} by {self.____}"',
      },
...
class Article(models.Model):
    ...
    class Meta:
      ...
      tieredHints: {
        apiSignature: 'class Meta: ordering = []; verbose_name_plural = ""',
...
# recent_books = author.books.filter(published_year__gte=2000)`,
      ...
      tieredHints: {
        apiSignature: 'models.ForeignKey(to, on_delete, related_name=None)',
        skeleton: 'from django.db import models\n\nclass Author(models.Model):\n    name = models.____(max_length=200)\n\n    def ____(self):\n        ____ self.____\n\nclass Book(models.Model):\n    title = models.____(max_length=300)\n    published_year = models.____()\n    author = models.____(Author, ____=models.____, ____="books")\n\n    def ____(self):\n        ____ self.____',
      },
...
# Tag.objects.get(name="python").articles.all()  — reverse lookup`,
      ...
      tieredHints: {
        apiSignature: 'models.ManyToManyField(to, related_name=None)',
        skeleton: 'from django.db import models\n\nclass Tag(models.Model):\n    name = models.____(max_length=50, ____=True)\n\n    def ____(self):\n        ____ self.____\n\nclass Article(models.Model):\n    title = models.____(max_length=200)\n    tags = models.____(Tag, ____="____")\n\n    def ____(self):\n        ____ self.____',
      },
...
# With date: Enrollment.objects.filter(student=student).select_related("course")`,
      ...
      tieredHints: {
        apiSignature: 'models.ManyToManyField(to, through=None, related_name=None)',
        skeleton: 'from django.db import models\nfrom django.utils import ____\n\nclass Student(models.____):\n    name = models.____(max_length=100)\n\nclass Course(models.____):\n    title = models.____(max_length=200)\n    students = models.____(\n        ____,\n        ____=\'____\',\n        ____=\'courses\'\n    )\n\nclass Enrollment(models.____):\n    student = models.____(____, ____=models.____)\n    course = models.____(____, ____=models.____)\n    enrolled_date = models.____(____=timezone.____)',
      },
...
class Product(models.Model):
    ...
    class Meta:
      ...
      tieredHints: {
        apiSignature: 'models.CheckConstraint(check=None, name="")',
        skeleton: 'from django.db import models\nfrom django.db.models import Q\n\nclass Product(models.Model):\n    name = models.CharField(max_length=200)\n    sku = models.CharField(max_length=50)\n    price = models.DecimalField(max_digits=10, decimal_places=2)\n    is_active = models.BooleanField(default=True)\n\n    class Meta:\n        constraints = [\n            models.____(check=Q(price__gte=0), name="product_price_non_negative"),\n            models.____(fields=["sku"], condition=Q(is_active=____), name="unique_active_sku"),\n        ]',
      },
...
class Profile(models.Model):
    ...
    website = models.URLField(blank=True)`,
      ...
      tieredHints: {
        apiSignature: 'models.OneToOneField(to, on_delete, related_name=None)',
        skeleton: 'from django.contrib.auth.models import User\nfrom django.db import models\n\nclass Profile(models.Model):\n    user = models.____(User, ____=models.____, ____="profile")\n    bio = models.____(____=True)\n    website = models.____(____=True)',
      },
...
class Comment(TimeStampedModel):
    body = models.TextField()`,
      ...
      tieredHints: {
        apiSignature: 'class Meta: abstract = True',
        skeleton: 'from django.db import models\n\nclass TimeStampedModel(models.____):\n    created_at = models.____(____=True)\n    updated_at = models.____(____=True)\n\n    class ____:\n        ____ = True\n\nclass Article(____):\n    title = models.____(max_length=200)\n\nclass Comment(____):\n    body = models.____()',
      },
...
class Article(models.Model):
    ...
    def save(self, *args, **kwargs):
      ...
      tieredHints: {
        apiSignature: 'slugify(value, allow_unicode=False) -> str',
        skeleton: 'from django.db import models\nfrom django.utils.text import ____\n\nclass Article(models.____):\n    title = models.____(____=200)\n    slug = models.____(____=True)\n\n    def ____(self, *args, **kwargs):\n        if ____ self.____:\n            self.____ = ____(self.____)\n        ____().____(*args, **kwargs)',
      },
...
class Order(models.Model):
    ...
    total = models.DecimalField(max_digits=10, decimal_places=2)`,
      ...
      tieredHints: {
        apiSignature: 'models.UUIDField(primary_key=False, default=NOT_PROVIDED, editable=True)',
        skeleton: 'import uuid\nfrom django.db import models\n\nclass Order(models.Model):\n    id = models.____(____=True, ____=uuid.____, ____=False)\n    total = models.____(max_digits=10, decimal_places=2)',
      },
