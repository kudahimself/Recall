...
function RegistrationForm({ onSubmit }) {
  ...
  // 4. MC: What does zodResolver do? (correct answer index 0 → position a)
  {
    ...
    options: [
      {
        id: 'a',
        text: 'It bridges Zod validation with React Hook Form — it runs the Zod schema on submit/blur/change and translates Zod errors into the format RHF expects in formState.errors',
        isCorrect: true,
      },
      {
        id: 'b',
        text: 'It converts Zod schemas into HTML5 validation attributes like required and minlength on the input elements',
        isCorrect: false,
      },
      {
        id: 'c',
        text: 'It replaces React Hook Form entirely and uses Zod\'s own form rendering system',
        isCorrect: false,
      },
      {
        id: 'd',
        text: 'It only validates on form submission and cannot run on blur or change events',
        isCorrect: false,
      },
    ],
    explanation:
